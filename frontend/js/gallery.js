    ...
    try {
        ...
        data.forEach(item => {
            ...
            if (item.media_type === "video") {
                ...
                `;
                card.querySelector("img").addEventListener("click", () => showPopup(item));
...
function showPopup(project) {
    ...
    popup.classList.add("fixed", "inset-0", "bg-black", "bg-opacity-70", "flex", "items-center", "justify-center", "z-50");
